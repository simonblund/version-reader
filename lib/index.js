...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.findVersionLine = void 0;
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const allowFeatureBranches = core.getBooleanInput('allow_feature_branches');
            const fileContents = yield readFile(filename, filelocation);
...
function findVersionLine(content, prepend, append) {
...
exports.findVersionLine = findVersionLine;
function readFile(filename, filelocation) {
    return __awaiter(this, void 0, void 0, function* () {
